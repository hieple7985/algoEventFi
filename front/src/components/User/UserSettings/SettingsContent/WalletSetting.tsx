...
import IMG_Algo from '../../../../assets/images/icon-algorand.png'
        ...
        <section className='wallet-setting-section'>
          ...
          <div className='balance-items'>
            ...
            <div className='mt-3 flex justify-between items-start'>
              <div className='flex items-center'>
                <img src={IMG_Algo} alt="Algorand" className='object-cover h-6'/>
                <p className='ml-3 text-lg'>Algorand</p>
              </div>
              <div className='flex flex-col items-end'>
                <p className='text-lg font-semibold'>{Number.isInteger(userData.store.account.balance) ? Number(userData.store.account.balance) : Number(userData.store.account.balance).toFixed(4)}<span> ALGO</span></p>
                {loading
                ?
                  <p>...</p>
                :
            ...
            {/* <div className='mt-3 flex justify-between items-start'>
              ...
              <div className='flex flex-col items-end'>
                <p className='text-lg font-semibold'>0.000<span> ALGO</span></p>
                <p className='ml-3 text-sm text-gray-500'>(0 $)</p>
              </div>
            </div> */}
          </div>
